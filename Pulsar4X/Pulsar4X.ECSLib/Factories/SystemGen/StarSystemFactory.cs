...
namespace Pulsar4X.ECSLib
{
    public class StarSystemFactory
    {
        ...
        public StarSystem CreateSol(Game game)
        {
            ...
            SystemBodyDB mercuryBodyDB = new SystemBodyDB {BodyType = BodyType.Terrestrial, SupportsPopulations = true};
            ...
            SystemBodyDB venusBodyDB = new SystemBodyDB { BodyType = BodyType.Terrestrial, SupportsPopulations = true };
            ...
            SystemBodyDB earthBodyDB = new SystemBodyDB { BodyType = BodyType.Terrestrial, SupportsPopulations = true };
            ...
            SystemBodyDB lunaBodyDB = new SystemBodyDB { BodyType = BodyType.Moon, SupportsPopulations = true };
            ...
            SystemBodyDB marsBodyDB = new SystemBodyDB { BodyType = BodyType.Terrestrial, SupportsPopulations = true };
        ...
        public StarSystem CreateEccTest(Game game)
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                SystemBodyDB planetBodyDB = new SystemBodyDB { BodyType = BodyType.Terrestrial, SupportsPopulations = true };
